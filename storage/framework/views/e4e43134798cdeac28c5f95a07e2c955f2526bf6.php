...
<?php elseif($message = Session::get('status') ): ?>
<div class="container">
        <div class="row">
          <div class="col-lg-4">
            <div class="bs-component">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="col-lg-10 offset-lg-1">
              <form id="addform" class="bs-component" method="POST" action="<?php echo e(action('TestController@store')); ?>" accept-charset="UTF-8" >
                <?php echo csrf_field(); ?>
